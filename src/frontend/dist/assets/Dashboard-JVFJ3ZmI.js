import { c as createLucideIcon, j as jsxRuntimeExports, B as Button, a as cn, r as reactExports, R as React, b as composeRefs, d as reactDomExports, u as useComposedRefs, e as ReactDOM, L as LoaderCircle, f as ue, S as Slot$2, g as cva, h as React2, K as Key } from "./index-BC_BpiJv.js";
import { u as useCreateKey, L as Label$1, I as Input, a as useListReturnRequests, b as useDismissReturnRequest, S as Skeleton, f as formatTimestamp, c as useMarkKeyReturned, d as useDeleteKey, i as isKeyActive, e as isKeyReturned, C as CircleCheck, g as useGetReturnRequestCount, h as useListKeys } from "./useRequests-BtpamvOB.js";
/**
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-muted flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-7 h-7 text-muted-foreground", "aria-hidden": "true" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground mb-1.5", children: title }),
...
function CreateKeyModal({ open, onOpenChange }) {
  ...
  async function handleSubmit(e) {
    ...
    if (!validate()) return;
    createKey.mutate(
      { tag: tag.trim(), description: description.trim() || void 0 },
      {
        onSuccess: () => {
          ue.success(`Key "${tag.trim()}" created`);
          handleClose();
        },
        onError: () => ue.error("Failed to create key")
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", "data-ocid": "create-key-modal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-lg", children: "Add New Key" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5 pt-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label$1, { htmlFor: "key-tag", className: "text-sm font-medium", children: [
          "Tag ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            ...
            "aria-describedby": tagError ? "tag-error" : void 0,
            "data-ocid": "create-key-tag-input",
            autoFocus: true
          }
        ),
        tagError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "tag-error", className: "text-xs text-destructive", children: tagError })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label$1, { htmlFor: "key-description", className: "text-sm font-medium", children: [
          "Description",
          " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: createKey.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin mr-1.5" }),
              "Creating…"
            ] }) : "Create Key"
          }
        )
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: request.finderName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: request.finderContact }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: formatTimestamp(request.createdAt) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
...
function RequestsPanel({ keyId }) {
  const { data: requests, isLoading } = useListReturnRequests(keyId);
  const dismiss = useDismissReturnRequest();
  function handleDismiss(requestId) {
    dismiss.mutate(
      { requestId, keyId },
      {
        onSuccess: () => ue.success("Request dismissed"),
        onError: () => ue.error("Failed to dismiss request")
      }
    );
  }
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-2", "data-ocid": "requests-loading", children: [
  ...
  if (active.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        ...
        children: "No pending return requests."
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/40", "data-ocid": "requests-panel", children: active.map((req) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    RequestRow,
    {
      request: req,
...
function QRCodeImage({ url, tag }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "qr-container w-[120px] h-[120px] shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: qrSrc,
...
function RequestCountBadge({ keyId }) {
  const { data: count2 } = useGetReturnRequestCount(keyId);
  const n = Number(count2 ?? 0n);
  if (n === 0) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Badge,
    {
...
function KeyCard({ keyItem }) {
  ...
  const finderUrl = typeof window !== "undefined" ? `${window.location.origin}/find/${keyItem.id.toString()}` : `/find/${keyItem.id.toString()}`;
  function handleCopyLink() {
    navigator.clipboard.writeText(finderUrl).then(
      () => ue.success("Finder link copied!"),
      () => ue.error("Could not copy link")
    );
  }
  function handleMarkReturned() {
    markReturned.mutate(keyItem.id, {
      onSuccess: () => ue.success(`"${keyItem.tag}" marked as returned`),
      onError: () => ue.error("Failed to update key status")
    });
  }
  function handleDelete() {
    deleteKey.mutate(keyItem.id, {
      onSuccess: () => ue.success(`"${keyItem.tag}" deleted`),
      onError: () => ue.error("Failed to delete key")
    });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  className: active ? "bg-primary/10 text-primary border border-primary/20 text-xs font-medium" : "bg-accent/15 text-accent-foreground border border-accent/30 text-xs font-medium",
                  "data-ocid": "key-status-badge",
                  children: active ? "Active" : "Returned"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(RequestCountBadge, { keyId: keyItem.id })
            ] }),
            keyItem.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 line-clamp-2", children: keyItem.description })
          ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-40", children: [
              ...
              active && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DropdownMenuItem,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5 mr-2" }),
                    "Mark returned"
                  ]
                }
              ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-4 pb-4 flex-1 flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(QRCodeImage, { url: finderUrl, tag: keyItem.tag }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-snug", children: "Share this QR code so a finder can submit a return request." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  variant: "outline",
              ...
              returned && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-accent-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Key has been returned" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Return Requests" }),
                expanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-3.5 h-3.5 group-hover:text-primary transition-colors" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3.5 h-3.5 group-hover:text-primary transition-colors" })
              ]
            }
          ),
          expanded && /* @__PURE__ */ jsxRuntimeExports.jsx(RequestsPanel, { keyId: keyItem.id })
        ] })
      ]
    }
  );
...
function KeyCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 pt-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-[120px] h-[120px] rounded-lg" }),
...
function Dashboard() {
  ...
  const filtered = (keys ?? []).filter(
    (k) => k.tag.toLowerCase().includes(search.toLowerCase())
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "dashboard-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage your registered keys and return requests." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    ((keys == null ? void 0 : keys.length) ?? 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-sm", children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: Array.from({ length: 3 }).map((_, i) => (
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(KeyCardSkeleton, {}, i)
        ))
      }
    ) : search && filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    ) : ((keys == null ? void 0 : keys.length) ?? 0) === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      EmptyState,
      {
        icon: Key,
      ...
      "div",
      {
        className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4",
        "data-ocid": "keys-grid",
        children: filtered.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(KeyCard, { keyItem: key }, key.id.toString()))
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CreateKeyModal, { open: modalOpen, onOpenChange: setModalOpen })
  ] });
}
export {
